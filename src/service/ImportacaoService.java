 ...
 * @author janio
 */
public class ImportacaoService implements Runnable {
    ...
    public void apenasLerArquivosGravarCB(String caminho, String destino, Rectangle clip, boolean gravaImagemDesidentificada) throws IOException {
        ...
        frame.setPreferredSize(new Dimension(100, 800));
    ...
    protected TbImportacao decodificaCodigoBarras(File arquivoAtual, BufferedImage imagemOriginal, boolean flTentarNomeArquivo) {
    ...
    protected BufferedImage cropSubimageWithRectangle(BufferedImage original, Rectangle areaDeCorte) {
        /*
        ...
        for (int i = 0; i < totalArquivos; i++) {
            ...
            /*
                ...
                if (rs.getFlProcesso() == false) {
                    recorteImagem.ConsultaInsereProcesso(rs.getProcesso(), rs.getNomeProcesso());
                }
                ...
                if (rs.getFlDisciplinaVestibular() == false) {
                    recorteImagem.ConsultaInsereDisciplinaVestibular(rs.getDisciplina(), rs.getNomeDisciplinaOrigem());
                }
...
*/
                ...
                codigoRetorno = rs.importaArquivo(arquivoAtual, bancoOrigem, this.getParamBancoDestino(), imagemCortada);
